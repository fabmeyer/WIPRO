...
@Path( "/post/emitphoton/" )
public class PhotonEmitterPOSTAdapter {
	@Context
	private HttpServletRequest request;

	@POST
	@Produces( MediaType.APPLICATION_JSON )
	public Response encrypt(@FormParam( "base" ) String base, @FormParam( "str" ) String str, @FormParam("angle_variance") float angle_var, @FormParam("length_variance") float length_var )
	{
